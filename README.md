            ...
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn signin">MR.SIVAKUMAR B.Tech</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn signin">MR.SURENDHARAN B.E</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">CO FOUNDER</h5>
                  <a href="#" class="btn signin">MR.JAYASEELAN B.tech</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn signin">MR.SURIYAPARAKASH B.E</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn signin">MR.PANDIKUMAR B.E</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">ASS-DIRECTOR </h5>
                  <a href="#" class="btn signin">MR.SRIDHER B.E</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn signin">MR.ELAVARASU  B.E</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn signin">MR.HARISH B.Tech</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card">
                <img src="photo9.jpg" class="card-img-top" >
                <div class="card-body">
                  <h5 class="card-title">Ass-MANAGER</h5>
                  <a href="#" class="btn signin">MR.VIGNESH B.Tech</a>
                </div>
              </div>
            </div>
       </div>
...
## OUTPUT:
![alt text](<Screenshot 2024-04-29 000857.png>)

![alt text](<Screenshot 2024-04-29 000926.png>)

![alt text](<Screenshot 2024-04-29 000944.png>)

![alt text](<Screenshot 2024-04-29 001127.png>)

![alt text](<Screenshot 2024-04-29 001140.png>)
